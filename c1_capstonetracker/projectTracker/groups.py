...
administrative_users, _ = Group.objects.get_or_create(
    name='Administrative Users')
administrative_users.save()

employee_users, _ = Group.objects.get_or_create(
    name='Employee Users')
employee_users.save()

student_users, _ = Group.objects.get_or_create(
    name='Student Users')
student_users.save()
...
can_view_employees, _ = Permission.objects.get_or_create(
    name='Can View Employees',
    codename='can_view_employees',
    content_type=admin_ct)
can_view_employees.save()

can_view_projects, _ = Permission.objects.get_or_create(
    name='Can View Projects',
    codename='can_view_projects',
    content_type=admin_ct)
can_view_projects.save()

can_view_teams, _ = Permission.objects.get_or_create(
    name='Can View Teams',
    codename='can_view_teams',
    content_type=admin_ct)
can_view_teams.save()

can_view_schools, _ = Permission.objects.get_or_create(
...
can_edit_schools, _ = Permission.objects.get_or_create(
    name='Can Edit Schools ',
    codename='can_edit_schools',
    content_type=admin_ct)
can_edit_schools.save()

can_edit_employees, _ = Permission.objects.get_or_create(
    name='Can Edit Employees ',
    codename='can_edit_employees',
    content_type=admin_ct)
can_edit_employees.save()

can_edit_teams, _ = Permission.objects.get_or_create(
    name='Can Edit Teams ',
    codename='can_edit_teams',
    content_type=admin_ct)
can_edit_teams.save()

can_edit_projects, _ = Permission.objects.get_or_create(
...
has_employee_profile, _ = Permission.objects.get_or_create(
